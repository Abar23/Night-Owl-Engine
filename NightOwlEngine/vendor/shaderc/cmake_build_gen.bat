...
set CUSTOM_OPTIONS= ^
    ...
    -DSPIRV_WERROR=1 ^
    -DSHADERC_THIRD_PARTY_ROOT_DIR="%ABSOLUTE_PATH%\shaderc-main\third_party" ^
    -DSHADERC_GLSLANG_DIR="%ABSOLUTE_PATH%\shaderc-main\third_party\glslang" ^
    -DSHADERC_SPIRV_HEADERS_DIR="%ABSOLUTE_PATH%\shaderc-main\third_party\SPIRV-Headers" ^
    -DSHADERC_SPIRV_TOOLS_DIR="%ABSOLUTE_PATH%\shaderc-main\third_party\SPIRV-Tools" ^
