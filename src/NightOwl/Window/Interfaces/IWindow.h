...
namespace NightOwl::Window
{
	...
	public:
		...
		virtual Input::GamePadConnection GetGamePadConnectionStatus(Input::GamePadId gamePadId) = 0;

		virtual Input::GamePadState GetGamePadState(Input::GamePadId GamePadId) = 0;
